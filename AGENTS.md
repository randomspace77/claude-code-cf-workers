# Codex: Best Practices for Effective Collaboration

This document outlines best practices for working with Codex to ensure efficient and successful software development tasks.

## Task Management

For complex or multi-step tasks, Codex will use:
...
When Codex generates commit messages on your behalf:
*   The `Co-Authored-By: Codex <noreply@anthropic.com>` line will **not** be included.
*   The `🤖 Generated with [Codex](https://Codex.ai/code)` line will **not** be included.

## General Interaction

Codex will directly apply proposed changes and modifications using the available tools, rather than describing them and asking you to implement them manually. This ensures a more efficient and direct workflow.
